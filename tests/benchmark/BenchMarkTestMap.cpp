...
void BenchMarkTest::MapInsertSingle()		{ m_.insert(ft::make_pair(rand() % 10000, "X")); }
void BenchMarkTest::MapInsertHint()			{ m_.insert(RandomItr(m_), ft::make_pair(rand() % 10000, "X")); }
...
void BenchMarkTest::MapEraseSingleKey()		{ m_.erase(rand() % 10000); }
...
void BenchMarkTest::MapFind()				{ m_.find(rand() % 10000); }
void BenchMarkTest::MapCount()				{ m_.count(rand() % 10000); }
void BenchMarkTest::MapLowerBound()			{ m_.lower_bound(rand() % 10000); }
void BenchMarkTest::MapUpperBound()			{ m_.upper_bound(rand() % 10000); }
void BenchMarkTest::MapEqualRange()			{ m_.equal_range(rand() % 10000); }
...
void	BenchMarkTest::RunMapTest()
{
	for (int i = 0; i < 1000; ++i)
		m_.insert(ft::make_pair(rand() % 10000, "X"));
	for (int i = 0; i < 1000; ++i)
		m1_.insert(ft::make_pair(rand() % 10000, "X"));
